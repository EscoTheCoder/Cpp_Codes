...
int main() {
    ...
    vector<std::string> playerNames(paixtes);
    ...
    int gyroi;
    cout << "Grapse posous gyrous thelete na paijoume"<<endl;
    ...
    for (int counter1 = 0; counter1 < paixtes; counter1++) {
        ...
        while (counter < gyroi) {
            ...
            if (flag == true) {
                std::cout << "Eisai grigoros telika mpravo";
            } else {
                if (cnt == 0) {
                    cout << "Eisai xazoulhs";
                } else if (cnt == 1) {
                    misesnikes++;
                    if (seires1) {
                        cout << "Niwtheis na metras mono orizontia.";
                    }
                    if (stiles1) {
                        cout << "Niwtheis na metras mono katheta";
                    }
                }
            }
            counter++;
